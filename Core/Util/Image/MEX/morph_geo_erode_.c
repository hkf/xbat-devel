...
//			 
// morph_erode_geo_double - morphological geodesic erosion
// -------------------------------------------------------
// 
// Input:
// ------
...
// Output:
// -------
//  *Y - pointer to eroded image (double *, (m - 2)*(n - 2))
...
//			 
// morph_erode_geo_uint8 - morphological geodesic erosion
// ------------------------------------------------------
// 
// Input:
// ------
...
// Output:
// -------
//  *Y - pointer to eroded image (uint8 *, (m - 2)*(n - 2))
//  *A - pointer to activity image (uint8 *, (m - 2)*(n - 2))
//


void morph_erode_geo_uint8 (
...
// ----------------------------------------------------
//
// [Y,A] = morph_erode_geo_double(X,M,Z)
//
// Input:
// ------
...
// Output:
// -------
//  Y - geodesically eroded image (double)
//  A - activity image
//
  	...
  	if (mxGetClassID(prhs[0]) == mxUINT8_CLASS) {
		...
		//--
  		...
  		*(d + 1) = (n - 2);
  		...
  		// allocate geodesically eroded image  
  		...
  		morph_erode_geo_uint8 (Y8, A, X8, M8, m, n, Z);
