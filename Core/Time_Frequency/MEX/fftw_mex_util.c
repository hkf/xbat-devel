...
// --------------------------------------------------------
//
// mx_to_fftw (fftw_complex *X, double *Xr, double *Xi, int N)
//
// Input:
// ------
...
// --------------------------------------------------------------
//
// fftw_to_mx (double *Xr, double *Xi, fftw_complex *X, int N)
//
// Input:
// ------
//  X - pointer to fftw complex array
...
// ---------------------------------------------------------------------------
//
// hc_fftw_to_mx (double *Xr, double *Xi, double *Yfhc, int N)
//
// Input:
// ------
...
// --------------------------------------------------------------------------------
//
// hc_fftw_to_half_mx (double *Xr, double *Xi, double *Yfhc, int N)
//
// Input:
// ------
//  X - pointer to fftw real array storing half complex vector
...
// --------------------------------------
//
// hc_mult (double *Y, double *X1, double X2, int N)
//
// Input:
// ------
...
void hc_mult (
	FFT_TYPE *Y, FFT_TYPE *X1, FFT_TYPE *X2, int N
)
...
// -----------------------------------------------------------------
//
// hc_power_spectrum (double *P, double *X, int N)
//
// Input:
// ------
//  X - pointer to fftw real array storing half complex vector
...
// -----------------------------------------------------------------
//
// vec_mult(FFT_TYPE *Y, FFT_TYPE *X1, FFT_TYPE *X2, unsigned int N)
//
// Input:
// ------
...
void vec_mult(FFT_TYPE *Y, FFT_TYPE *X1, FFT_TYPE *X2, unsigned int N)
{
	int k;
	for (k = 0; k < N; k++) {		
		*(Y + k) = *(X1 + k) * *(X2 + k);		
