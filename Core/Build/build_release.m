...
output = create_dir(fullfile(get_desktop, 'RELEASES'));
...
% NOTE: previously we used Tortoise for speed and better feedback, this has changed
...
here = pwd; cd(output); [ignore, name] = fileparts(xbat_root); %#ok<ASGLU>

svn('export', info.url, name);
